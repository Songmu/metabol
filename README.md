...
% curl -sfL https://raw.githubusercontent.com/Songmu/thresh/main/install.sh | sh -s -- -b $(go env GOPATH)/bin [vX.Y.Z]

# In alpine linux (as it does not come with curl by default)
% wget -O - -q https://raw.githubusercontent.com/Songmu/thresh/main/install.sh | sh -s [vX.Y.Z]
